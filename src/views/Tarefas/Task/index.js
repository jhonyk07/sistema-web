...
import TypeIcons from '../../../utils/Tarefas/typeIcons';
...
function Task({match}) {
    ...
    //checar variável macaddress para retirada
  ...
  return (
    ...
    <S.Form>
        ...
        <S.Input>
            <span>Data</span>
            <input type="date" placeholder="Detalhes da tarefa..."
            onChange={e =>setDate(e.target.value)} value={date} />
            <img src={iconCalendar} alt="Calendário" />
        </S.Input>
        <S.Input>
            <span>Hora</span>
            <input type="time" placeholder="Detalhes da tarefa..."
